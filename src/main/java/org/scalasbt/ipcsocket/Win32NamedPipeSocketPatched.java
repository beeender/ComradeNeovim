...
/**
 * Copy of https://github.com/sbt/ipcsocket/blob/master/src/main/java/org/scalasbt/ipcsocket/Win32NamedPipeSocket.java
 * The version 1.0.1 is not released on maven.
 */
public class Win32NamedPipeSocketPatched extends Socket {
     ...
     */
    public Win32NamedPipeSocketPatched(
            HANDLE handle,
    ...
    public Win32NamedPipeSocketPatched(String pipeName) throws IOException {
